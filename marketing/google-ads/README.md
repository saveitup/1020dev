...
- Ein **Click-Listener** auf `<a href="https://cal.com/1020dev*">` (matcht auch `cal.eu/1020dev`) firet automatisch die **Booking-Conversion** — egal ob der Link im Hero, Nav, Footer, Pricing oder Audit-Success-Screen klickt wird.
